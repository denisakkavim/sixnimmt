"""Where a match's events are kept, and how they reach waiting subscribers.
...
class EventSink(Protocol):
    """Where a match's events go. Phase 4 adds a JSONL implementation."""
...
class InMemoryEventSink:
    """Holds the match log and serves each viewer their own filtered slice."""
