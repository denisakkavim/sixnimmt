...
the communication fixture then commits and uncommits. Its historical replay count
...
Protocol field names use the current schema; the event sequence and historical
action counts are preserved.
